...
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=high    # optional: high on anchor AND all six spread edits (priciest)
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=medium  # optional: medium on anchor + edits (omit secret for high anchor / medium spreads)
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=low       # optional: cheapest — low on anchor + edits
# # If you omit STORYBOOK_GPTIMAGE_QUALITY: anchor = high, six spread edits = medium (detail + lower cost than all-high).
