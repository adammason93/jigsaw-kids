...
# supabase secrets set STORYBOOK_GPTIMAGE_CHUNK_WAIT_MS=35000   # cooldown between chunks (default 35000ms; raise to 45000+ if you still see 429s on tier 1)
```
