...
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=high    # optional: priciest (anchor + edits)
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=medium  # optional: force medium on edits too (omit secret for edit=low default)
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=low       # optional: cheapest anchor + edits
# # If you omit STORYBOOK_GPTIMAGE_QUALITY: anchor generation = medium, six spread edits = low (saves vs all-medium).
