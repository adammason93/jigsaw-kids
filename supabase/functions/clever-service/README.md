...
# supabase secrets set STORYBOOK_GPTIMAGE_QUALITY=medium       # low | medium | high | auto — code default medium (happy medium vs cost); low if 546/429
# supabase secrets set STORYBOOK_GPTIMAGE_INPUT_FIDELITY=low    # edits: low | high — code default low (saves vs high); high = tighter anchor match, costs more
