...
- Include fields title (string), characterDesign (string), and pages (array of 12 objects).
  For "characterDesign": write an EXTREMELY detailed visual description of EVERY character in the story (hero, buddy, family, friends, creatures). For each character, you MUST define their EXACT gender (e.g. boy/girl), age, height, body shape, skin tone, eye color, eye shape, nose shape, mouth shape, facial expression/smile, hair color, hair style, AND hair texture/material (e.g. "smooth sculpted clay hair", "fuzzy felt fur"), plus ONE specific, unchanging outfit with exact colors, patterns, and clothing items (e.g., "Sofia: a 5-year-old girl, short and chubby, round face, small button nose, wide happy smile, light peach skin, big round green eyes, blonde wavy shoulder-length hair made of smooth sculpted clay, wearing a cream hoodie with a brown bunny graphic, olive green cargo pants, and white sneakers. The Unicorn: a small chubby unicorn with smooth white clay skin, a shiny metallic gold horn, and a mane made of smooth pastel-rainbow sculpted clay"). DO NOT give them multiple outfits. This will be used as the master reference to keep them identical across all illustrations.
