...
- Include fields title (string), characterDesign (string), and pages (array of 12 objects).
  For "characterDesign": write an EXTREMELY detailed visual description of EVERY character in the story (hero, buddy, family, friends, creatures). For each character, you MUST define their EXACT gender (e.g. boy/girl), age, height, body shape, skin tone, eye color, eye shape, nose shape, mouth shape, facial expression/smile, hair color, and hair style, plus ONE specific, unchanging outfit with exact colors, patterns, and clothing items (e.g., "Sofia: a 5-year-old girl, short and chubby, round face, small button nose, wide happy smile, light peach skin, big round green eyes, blonde wavy shoulder-length hair, wearing a cream hoodie with a brown bunny graphic, olive green cargo pants, and white sneakers. Freya: a 6-year-old girl, tall and thin, oval face, freckles, brown skin, almond brown eyes, dark brown hair in a top bun, wearing a purple and green color-block zip jacket with green shorts and striped socks"). DO NOT give them multiple outfits. This will be used as the master reference to keep them identical across all illustrations.
...
Return JSON shape: { "title": string, "characterDesign": string, "pages": [ { "text": string, "illustrationBrief": string | null }, ... 12 items ] }`;
  ...
  const imagePromptPrefix =
    ...
    `MASTER CHARACTER DESIGNS (You MUST use these exact outfits, genders, ages, body shapes, facial features, skin tones, and hair styles in every image to maintain perfect consistency): ${finalCharacterDesc}. ` +
