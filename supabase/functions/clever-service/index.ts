...
- Include fields title (string), characterDesign (string), and pages (array of 12 objects).
  For "characterDesign": write an EXTREMELY detailed visual description of EVERY character in the story (hero, buddy, family, friends, creatures). For each character, you MUST define their EXACT age, height, body shape, skin tone, eye color, eye shape, nose shape, mouth shape, facial expression/smile, hair color, and hair style, plus ONE specific, unchanging outfit with exact colors, patterns, and clothing items (e.g., "Sofia: 5 years old, short and chubby, round face, small button nose, wide happy smile, light peach skin, big round green eyes, blonde wavy shoulder-length hair, wearing a cream hoodie with a brown bunny graphic, olive green cargo pants, and white sneakers. Freya: 6 years old, tall and thin, oval face, freckles, brown skin, almond brown eyes, dark brown hair in a top bun, wearing a purple and green color-block zip jacket with green shorts and striped socks"). DO NOT give them multiple outfits. This will be used as the master reference to keep them identical across all illustrations.
